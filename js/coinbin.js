$(document).ready(function() {
		...
		if(email.match(/[\s\w\d]+@[\s\w\d]+/g)) {
			if($("#openPass").val().length>=10) {
				if($("#openPass").val()==$("#openPassConfirm").val()) {
					...
					else if(host=="komodo_mainnet") {$("#walletHistory").attr('href','https://kmdexplorer.io/address/'+address);}
					else if(host=="reddcoin_mainnet") {$("#walletHistory").attr('href','https://live.reddcoin.com/address/'+address);}
					else if(host=="zcoin_mainnet") {$("#walletHistory").attr('href','https://explorer.zcoin.io/address/'+address);}
					...
					if(host=='pandacoin_mainnet') {
						...
						qrcode.makeCode("reddcoin:"+address);
					} else if(host=='zcoin_mainnet') {
						qrcode.makeCode("zcoin:"+address);
	...
	$("#walletLogout").click(function() {
		...
		if(host=='pandacoin_mainnet') {
			...
			qrcode.makeCode("reddcoin:");
		} else if(host=='zcoin_mainnet') {
			qrcode.makeCode("zcoin:");
		} else if(host=='htmlcoin_mainnet') {
			...
			if(dvalue>=total) {
				...
				tx2.broadcast(function(data) {
					...
					if(host=='pandacoin_mainnet') {
						...
						if(data) {
							$("#walletSendConfirmStatus").removeClass('hidden').addClass('alert-success').html('txid: <a href="https://live.reddcoin.com/tx/' + data +'" target="_blank">'+ data +'</a>');
							$("#walletSendSuccessfulTransaction").removeClass('hidden');
							$("#walletSendSuccessfulTransaction textarea").val(signed);
						} else {
							$("#walletSendConfirmStatus").removeClass('hidden').addClass('alert-danger').html("Unable to Broadcast")
						...
						if(data) {
							$("#walletSendConfirmStatus").removeClass('hidden').addClass('alert-success').html('txid: <a href="https://chainz.cryptoid.info/ltc/tx.dws?' + data +'" target="_blank">'+ data +'</a>');
							$("#walletSendSuccessfulTransaction").removeClass('hidden');
							$("#walletSendSuccessfulTransaction textarea").val(signed);
						} else {
							$("#walletSendConfirmStatus").removeClass('hidden').addClass('alert-danger').html("Unable to Broadcast")
						...
						if(data) {
							$("#walletSendConfirmStatus").removeClass('hidden').addClass('alert-success').html('txid: <a href="https://explorer.zcoin.io/tx/' + data +'" target="_blank">'+ data +'</a>');
							$("#walletSendSuccessfulTransaction").removeClass('hidden');
							$("#walletSendSuccessfulTransaction textarea").val(signed);
						} else {
							$("#walletSendConfirmStatus").removeClass('hidden').addClass('alert-danger').html("Unable to Broadcast")
			...
			coinjs.addressBalance(host, $("#walletAddress").html(),function(data) {
				...
				if(host=='pandacoin_mainnet') {
					...
					if(data) {
						...
						$("#walletBalance").html((v/100000000).toFixed(8)+" RDD").attr('rel',v).fadeOut().fadeIn();
					} else {
						$("#walletBalance").html("0 RDDD").attr('rel',v).fadeOut().fadeIn();
					}
				} else if(host=='zcoin_mainnet') {
					if(data) {
						var v = JSON.parse(data)
						$("#walletBalance").html((v/100000000).toFixed(8)+" XZC").attr('rel',v).fadeOut().fadeIn();
					} else {
						$("#walletBalance").html("0 XZC").attr('rel',v).fadeOut().fadeIn();
					}
				} else if(host=='komodo_mainnet') {
					if(data) {
						var v = data
	...
	function listUnspentReddCoin(redeem) {
		$.ajax ({
			type: "GET",
			url: "https://cryptodepot.org:8083/rdd/listunspent/"+redeem.addr+"",
			dataType: "json",
			error: function(data) {
...
function rawSubmitReddCoin(thisbtn) {
	$(thisbtn).val('Please wait, loading...').attr('disabled',true);
	txhex = $("#rawTransaction").val().trim();
			$.ajax({
					type: "GET",
...
$(".qrcodeBtn").click(function() {
	...
	if(ta.length>0) {
		...
		if(host=='pandacoin_mainnet') {
			...
			qrstr = "reddcoin:"+$('.address',thisbtn).val();
		} else if(host=='zcoin_mainnet') {
			qrstr = "zcoin:"+$('.address',thisbtn).val();
		} else if(host=='htmlcoin_mainnet') {
...
$("#settingsBtn").click(function() {
	...
	if(host=='pandacoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "pnd";
	} else if(host=='zcoin_mainnet') {
		document.getElementById("coinLogo").src = "images/logos/zxc.png";
		document.getElementById("broadCastTitle").textContent = "zCoin";
		document.getElementById("walletTitle").textContent = "zCoin";
		document.getElementById("market-ticker").innerHTML = `<coingecko-coin-market-ticker-list-widget  coin-id="zcoin" currency="usd" locale="en"></coingecko-coin-market-ticker-list-widget>`;
		document.getElementById("coingeckoinfo").innerHTML = `<center><a href="https://www.coingecko.com/en/coins/zcoin" target="_BLANK">zCoin CoinGecko Info</a></center>`;
		document.getElementById("transwarning").innerHTML = ``;
		document.getElementById("signwarning").innerHTML = ``;
		document.getElementById("broadcastwarning").innerHTML = ``;
		document.getElementById("spendTicker").innerHTML = `ZXC`;
		document.getElementById("WalletSpendWarning").innerHTML = ``;
		document.getElementById("developerDonation").value = `1.0`;
		document.title = 'zCoin - Multi Wallet';
		document.getElementById("giftlinkinput1").value = "zxc";
	} else if(host=='reddcoin_mainnet') {
		document.getElementById("coinLogo").src = "images/logos/rdd.png";
		document.getElementById("broadCastTitle").textContent = "Reddcoin";
		document.getElementById("walletTitle").textContent = "Reddcoin";
		document.getElementById("market-ticker").innerHTML = `<coingecko-coin-market-ticker-list-widget  coin-id="reddcoin" currency="usd" locale="en"></coingecko-coin-market-ticker-list-widget>`;
		document.getElementById("coingeckoinfo").innerHTML = `<center><a href="https://www.coingecko.com/en/coins/reddcoin" target="_BLANK">Reddcoin CoinGecko Info</a></center>`;
		document.getElementById("transwarning").innerHTML = ``;
		document.getElementById("signwarning").innerHTML = ``;
		document.getElementById("broadcastwarning").innerHTML = ``;
		document.getElementById("spendTicker").innerHTML = `RDD`;
		document.getElementById("WalletSpendWarning").innerHTML = ``;
		document.getElementById("developerDonation").value = `1.0`;
		document.title = 'Reddcoin - Multi Wallet';
		document.getElementById("giftlinkinput1").value = "rdd";
	} else if(host=='komodo_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "kmd";
	} else if(host=='htmlcoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "html";
	} else if(host=='dimecoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "dime";
	} else if(host=='peercoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "ppc";
	} else if(host=='1x2coin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "1x2";
	} else if(host=='mintcoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "mint";
	} else if(host=='2x2_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "2x2";
	} else if(host=='mooncoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "moon";
	} else if(host=='2give_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "2give";
	} else if(host=='404_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "404";
	} else if(host=='42coin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "42";
	} else if(host=='axe_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "axe";
	} else if(host=='piratechain_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "arrr";
	} else if(host=='abbc_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "abbc";
	} else if(host=='actinium_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "acm";
	} else if(host=='adeptio_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "ade";
	} else if(host=='aegeus_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "aeg";
	} else if(host=='aiascoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "aias";
	} else if(host=='alexandrite_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "alex";
	} else if(host=='aricoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "ari";
	} else if(host=='auroracoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "aur";
	} else if(host=='aquariuscoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "arco";
	} else if(host=='arepacoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "arepa";
	} else if(host=='argentum_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "arg";
	} else if(host=='asiacoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "ac";
	} else if(host=='audiocoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "adc";
	} else if(host=='coinb.in') {
		...
		document.getElementById("giftlinkinput1").value = "btc";
	} else if(host=='blocknet_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "block";
	} else if(host=='cypherfunk_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "funk";
	} else if(host=='dash_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "dash";
	} else if(host=='deviantcoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "dev";
	} else if(host=='digibyte_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "dgb";
	} else if(host=='dogecoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "doge";
	} else if(host=='elite_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "1337";
	} else if(host=='litecoin_mainnet') {
		...
		document.getElementById("WalletSpendWarning").innerHTML = ``;
		document.getElementById("developerDonation").value = `1.0`;
		document.getElementById("giftlinkinput1").value = "ltc";
	} else if(host=='lynx_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "lynx";
	} else if(host=='mousecoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "mouse";
	} else if(host=='infiniterick_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "rick";
	} else if(host=='qtum_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "qtum";
	} else if(host=='syscoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "sys";
	} else if(host=='utip_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "utip";
	} else if(host=='viacoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "via";
	} else if(host=='zeitcoin_mainnet') {
		...
		document.getElementById("giftlinkinput1").value = "zeit";
	}

	$("#giftQrCode").html("");
	var qrcode = new QRCode("giftQrCode");
	qrcode.makeCode("https://"+ mainSiteUrl +"/?coin=" + document.getElementById("giftlinkinput1").value + "&email=" + document.getElementById("openEmail").value + "&password=" + document.getElementById("openPass").value + "#wallet");
...
$("#allcoinsSubmitButtonIDHere").click(function() {
	...
	else if(($("#allcoinsFormIDHere input[type='radio']:checked").val() == "zxc")) {
		$("#coinjs_coin").val("zcoin_mainnet").trigger("change");
		$("#coinjs_broadcast").val("zcoin_mainnet").trigger("change");
		$("#coinjs_utxo").val("zcoin_mainnet").trigger("change");
	}
	else if(($("#allcoinsFormIDHere input[type='radio']:checked").val() == "rdd")) {
		$("#coinjs_coin").val("reddcoin_mainnet").trigger("change");
		$("#coinjs_broadcast").val("reddcoin_mainnet").trigger("change");
		$("#coinjs_utxo").val("reddcoin_mainnet").trigger("change");
	}
...
if(coinUrl == null) {
	...
	$("#coinjs_coin").val("audiocoin_mainnet").trigger("change");
	$("#coinjs_broadcast").val("audiocoin_mainnet").trigger("change");
	$("#coinjs_utxo").val("audiocoin_mainnet").trigger("change");
	$("#settingsBtn").trigger("click");
}
else if(coinUrl == 'rdd') {
